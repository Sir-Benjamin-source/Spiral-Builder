# theory_review_package_test-bunny-pipeline

This is the **accompanying package generated by the Spiral ASCII Compiler** (Spiral-Builder/grokulator/ascii_compiler.py) for the program/theory "test-bunny-pipeline".
...
From code:
  ...
  agent = BunnyAgent(references={'bunny-configurator': '../../The-Spiral-Codex/sandbox/grok-review/theories/bunny-configurator-creative-multiplier.md', 'review-schema': '../../The-Spiral-Codex/sandbox/review-configs/standard_review_schema.json', 'review-protocol': '../../The-Spiral-Codex/station-identification/review_protocol.md'})
